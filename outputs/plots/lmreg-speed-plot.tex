% Created by tikzDevice version 0.12.3.1 on 2023-06-16 22:50:09
...
\path[draw=drawColor,line width= 0.6pt,line join=round,line cap=round,fill=fillColor] ( 29.47,186.21) rectangle (163.18,224.47);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (455.24,227.62);
\definecolor{fillColor}{RGB}{255,255,255}

\path[fill=fillColor] ( 34.97,203.09) rectangle ( 46.35,214.47);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (455.24,227.62);
\definecolor{drawColor}{RGB}{248,118,109}

\path[draw=drawColor,line width= 0.6pt] ( 40.66,204.23) --
	( 40.66,205.94);

\path[draw=drawColor,line width= 0.6pt] ( 40.66,211.63) --
	( 40.66,213.34);
\definecolor{fillColor}{RGB}{255,255,255}

\path[draw=drawColor,line width= 0.6pt,fill=fillColor] ( 36.39,205.94) rectangle ( 44.92,211.63);

\path[draw=drawColor,line width= 0.6pt] ( 36.39,208.78) --
	( 44.92,208.78);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (455.24,227.62);
...
\path[fill=fillColor] ( 34.97,191.71) rectangle ( 46.35,203.09);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (455.24,227.62);
\definecolor{drawColor}{RGB}{0,191,196}

\path[draw=drawColor,line width= 0.6pt] ( 40.66,192.85) --
	( 40.66,194.56);

\path[draw=drawColor,line width= 0.6pt] ( 40.66,200.25) --
	( 40.66,201.95);
\definecolor{fillColor}{RGB}{255,255,255}

\path[draw=drawColor,line width= 0.6pt,fill=fillColor] ( 36.39,194.56) rectangle ( 44.92,200.25);

\path[draw=drawColor,line width= 0.6pt] ( 36.39,197.40) --
	( 44.92,197.40);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (455.24,227.62);
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.75] at (104.26,206.20) {\texttt{fda::landmarkreg()}};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (455.24,227.62);
\definecolor{drawColor}{RGB}{0,0,0}

\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.75] at (104.26,194.82) {\texttt{landmark\_reg\_block()}};
\end{scope}
\begin{scope}
