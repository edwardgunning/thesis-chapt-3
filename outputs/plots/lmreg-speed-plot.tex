% Created by tikzDevice version 0.12.3.1 on 2023-06-16 22:44:53
...
\path[draw=drawColor,line width= 0.6pt,line join=round,line cap=round,fill=fillColor] ( 21.37,193.08) rectangle (171.28,237.03);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (455.24,227.62);
\definecolor{fillColor}{RGB}{255,255,255}

\path[fill=fillColor] ( 26.87,212.80) rectangle ( 41.09,227.03);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (455.24,227.62);
\definecolor{drawColor}{RGB}{248,118,109}

\path[draw=drawColor,line width= 0.6pt] ( 33.98,214.23) --
	( 33.98,216.36);

\path[draw=drawColor,line width= 0.6pt] ( 33.98,223.47) --
	( 33.98,225.61);
\definecolor{fillColor}{RGB}{255,255,255}

\path[draw=drawColor,line width= 0.6pt,fill=fillColor] ( 28.64,216.36) rectangle ( 39.31,223.47);

\path[draw=drawColor,line width= 0.6pt] ( 28.64,219.92) --
	( 39.31,219.92);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (455.24,227.62);
...
\path[fill=fillColor] ( 26.87,198.58) rectangle ( 41.09,212.80);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (455.24,227.62);
\definecolor{drawColor}{RGB}{0,191,196}

\path[draw=drawColor,line width= 0.6pt] ( 33.98,200.00) --
	( 33.98,202.13);

\path[draw=drawColor,line width= 0.6pt] ( 33.98,209.25) --
	( 33.98,211.38);
\definecolor{fillColor}{RGB}{255,255,255}

\path[draw=drawColor,line width= 0.6pt,fill=fillColor] ( 28.64,202.13) rectangle ( 39.31,209.25);

\path[draw=drawColor,line width= 0.6pt] ( 28.64,205.69) --
	( 39.31,205.69);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (455.24,227.62);
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.85] at (105.69,216.99) {\texttt{fda::landmarkreg()}};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (455.24,227.62);
\definecolor{drawColor}{RGB}{0,0,0}

\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.85] at (105.69,202.76) {\texttt{landmark\_reg\_block()}};
\end{scope}
\begin{scope}
